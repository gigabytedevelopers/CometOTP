...
object EntryThumbnail {
    ...
    enum class EntryThumbnails(val resource: Int, internal val assetType: AssetType) {
        ...
        Barter(R.drawable.thumb_barter),
        ...
        BlockFi(R.drawable.thumb_blockfi),
        ...
        ClickUp(R.drawable.thumb_clickup),
        ...
        Cowrywise(R.drawable.thumb_cowrywise),
        CozyCloud(R.drawable.thumb_cozycloud),
        cPanel(R.drawable.thumb_cpanel),
        Crowdin(R.drawable.thumb_crowdin),
        CrowdSupply(R.drawable.thumb_crowd_supply),
        CryptoCom(R.drawable.thumb_crypto_com),
        CryptoComDeFiWallet(R.drawable.thumb_crypto_com_defi_wallet),
        ...
        GateIo(R.drawable.thumb_gate_io),
        Geegpay(R.drawable.thumb_geegpay),
        Gemini(R.drawable.thumb_gemini),
        ...
        Intercom(R.drawable.thumb_intercom),
        ...
        NiceHash(R.drawable.thumb_nicehash),
        ...
        Onlyfans(R.drawable.thumb_onlyfans),
        Onshape(R.drawable.thumb_onshape),
        OpenAI(R.drawable.thumb_openai),
        ...
        Paystack(R.drawable.thumb_paystack),
        ...
        ProtonVPN(R.drawable.thumb_protonvpn),
        ...
        Reloadly(R.drawable.thumb_reloadly),
        ...
        TruthSocial(R.drawable.thumb_truthsocial),
        ...
        UbiquitiNetworks(R.drawable.thumb_ubiquiti),
        ...
        XendFinance(R.drawable.thumb_xend_finance),
