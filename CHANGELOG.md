 ...
 * Move: the Github repository was moved from flocke/CometOTP to CometOTP/CometOTP for better organization of collaborators
 ...
 * Bug fix: rename the apps launcher icon to "CometOTP" (Issue #6)
